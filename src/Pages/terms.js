    ...
    return (
        <div id='terms'>
            <div className='container max-w-[1300px] px-4'>
                <article id="post-105347" className="post-105347 post type-post status-publish format-standard has-post-thumbnail hentry category-popular-telegram tag-telegram tag-social">
                    <header className="entry-header">
                        <h1 className="entry-title font-bold mt-20 mb-10">Terms and Conditions</h1>
                        <div className="entry-meta">
                            <span className="posted-on">
                                <time className="entry-date published" datetime="17/11/2022">Last Updated on 17/11/2022</time></span>
                        </div>
                    </header>
                    <div className="entry-content">
                        <p>Thanks for using our products and services (“Services”). The Services are provided by Social LLC. Any dispute will be handled in UAE. By accessing this web site, you are agreeing to be bound by these web site Terms and Conditions of Use, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this web site are protected by applicable copyright and trademark law.</p>
                        <p>
                        ...
                        <p>The materials on this website are provided “as is”. We makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties, including without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights. Further, we do not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its Internet web site or otherwise relating to such materials or on any sites linked to this site.</p>
                        <p>
                            <strong>Limitations</strong>
                        </p>
                        <p>In no event shall we or our suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption,) arising out of the use or inability to use the materials on our web site, even if we or an authorized representative has been notified orally or in writing of the possibility of such damage. Because some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you.</p>
                        <p>
                            <strong>Billing</strong>
                        </p>
                        <p>Payments on our website are processed using either PayPal’s secure system or a secure and verified payment gateway, with no sensitive financial information being input through our website. Secure method of accepting payments is processed using SSL encryption. By purchasing our services you are explicitly agreeing that you clearly understand and agree to what you are purchasing and will not file a fraudulent dispute via PayPal, credit card or debit card institution.</p>
                        <p>Furthermore, you have authorization to use the credit card, debit card, PayPal account or any other payment source used to make the purchase. Upon a fraudulent attempt to file a dispute or chargeback, we receive the right, if necessary, to reset all followers and likes, terminate your account and/or permanently ban your IP address. Users acknowledge chargebacks, disputes, or payment reversals will not be carried out prior to discussing the situation with our support team.</p>
                        <p>
                        ...
                        <p>We have not reviewed all of the sites linked to its Internet web site and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by our site. Use of any such linked web site is at the user’s own risk.</p>
                        <p>
                            <strong>Site Terms of Use Modifications</strong>
                        </p>
                        <p>We may revise these terms of use for our web site at any time without notice. By using this web site you are agreeing to be bound by the then current version of these Terms and Conditions of Use.</p>
                        <p>
                            <strong>Governing Law</strong>
                        </p>
                        <p>Any claim relating to our website shall be governed by the laws of UAE without regard to its conflict of law provisions. General Terms and Conditions are applicable to Use of a Web Site.</p>
                        <p>
                        ...
                        <ol>
                            <li>We are not affiliated with Instagram, Facebook or any Instagram third-party partners in any way.</li>
                            <li>It is your sole responsibility to comply with Instagram rules and any legislation that you are subject to. You use our website at your own risk.</li>
                            ...
                            <li>It is the sole responsibility of the customers to ensure their accounts are set to “public” during their use of our service. Any downtime of service in relation to a client changing their profile to “private” will not result in any payment reimbursement for that period of time.</li>
