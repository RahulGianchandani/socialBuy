    ...
    <div id='insta' className='servicePage'>
      <div className='mb-16'>
        <div className="text-center pt-24">
          <h1 className="px-4 py-2  bg-gray-200 inline rounded-full text-sm font-bold mb-6">BUY TIKTOK LIVE VIEWS</h1>
          ...
          <div className='flex-col flex items-center sm:px-3'>
            <div className='pricesSelect'>
              <select className="border !border-[#ed1c25] outline-none p-2 rounded-md youtube_channel" name="selectedPackageId" id="packageSelectBox" onChange={(e) => setPriceSelected(e.target.value)}>
                <option value="9.99€">250 Live Views - 9.99€</option>
                <option value="18.99€">500 Live Views - 18.99€</option>
                <option value="34.99€">1000 Live Views - 34.99€</option>
                <option value="69.99€">2500 Live Views - 69.99€</option>
                <option value="84.99€">5000 Live Views - 84.99€</option>
              </select>
            </div>
            <div className="monet_wrap w-96 !pt-8 !pb-4 max-sm:px-5 max-sm:!mx-[15px] ">
              <ul className="monet_ul max-sm:text-center">
                ...
                <li className='flex mb-3'>
                  <img src={lockIcon} />
                  <span>High Quality Live Views</span>
                </li>
                <li className='flex mb-3'>
                  <img src={userIcon} />
...
export default TiktokBuyLiveViews
