    ...
    <div id='homePage'>
      ...
      <header id='serviceSec' className='bg-[#f7f7fb] duration-300 pb-[225px] px-4 '>
        <div className='flex justify-center heading'>
          <h1 className=" w-max pt-24 text-center relative text-5xl tracking-tight font-extrabold text-black sm:text-5xl md:text-[4.75rem] !leading-[1.2]"> FameDaddy <br />Your Social Media <br />Super Power
        ...
        <p className='text-center mx-auto  mt-14 text-[26px] md:max-w-[42rem] leading-[33.8px]'>FameDaddy is the best place to boost your Social Media. We have the highest quality and latest technology, our service is unmatched. We are the best. So Try FameDaddy now</p>
      ...
      <div id='FAQsection' className='max-sm:px-7'>
        ...
        <p className="text-black mt-[20px] mb-[30px]  leading-7 text-xl max-sm:text-[1.1rem] text-center">Frequently asked questions about our services and FameDaddy</p>
              ...
              <div>
                ...
                <div className="accordion-item !rounded-none  duration-500 border-0 mb-[20px] ">
                  ...
                  <div id="collapseFive" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body border border-[#eee]">
                      <div class="panel show">
                        <p>Yes – FameDaddy sells high-quality followers. You’ll know this when you see the kind of followers that they deliver to your page. If they weren’t high quality, they would only follow you for a short time before unfollowing you again.</p>
                        <p>Because the followers that FameDaddy delivers are quality, you know that they’re going to make your account look popular for a long time. This is why FameDaddy has built itself an upstanding reputation.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div className="accordion-item !rounded-none  duration-500 border-0 mb-[20px] ">
                  ...
                  <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body border border-[#eee]">
                      <div class="panel">
                        <p><strong>No – you can only get your account banned</strong> if you have suspicious activity on your account. Suspicious activity includes engaging too much in a small timeframe.&nbsp;</p><p>FameDaddy, like other reputable social media marketing service unlike other companies out there, know when enough is enough and stagger their engagement so that it doesn’t look spammy.&nbsp;</p><p>If your engagement is natural looking, then your profile is going to be safe, which they are going to look past you, and you don’t have to worry about being banned. This also means that<strong> FameDaddy is safe to use</strong> – they’re not going to bring up ‘blocked action’ notifications or anything like that.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div id="collapseFour" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body border border-[#eee]">
                      <div class="panel show">
                        ...
                        <p>FameDaddy is widely respected as one of the best social media tools in the market. They have been endorsed by major networks such as Deccan Herald, JeffBullas, Startup Info, Outlookindia, Earthweb and the New York Times.</p>
                        <p>Companies like FameDaddy have the services to make your YouTube engagement happen, and make it happen in a big way. No longer do you have to worry about who is seeing your content, because, with a social media marketing service, only the right people will.</p>
                        <p>FameDaddy specialises in offering services for; <a className='text-[#36f]' href="../../../../youtube/">YouTube</a>, <a className='text-[#36f]' href="../../../../tiktok/">TikTok</a>, <a className='text-[#36f]' href="../../../../twitter/">Twitter</a>, <a className='text-[#36f]' href="../../../../instagram/">Instagram</a> and <a className='text-[#36f]' href="../../../../facebook/">Facebook</a>. While constantly expanding our services we are experts in these platforms, you can <a className='text-[#36f]' href="../../../../buy-youtube-subscribers/">Buy YouTube Subscribers</a> with the highest quality guaranteed.</p>
                      </div>
                    </div>
                  </div>
                </div>
